...
ALIAS_ZONE = {
    ...
    "Lozere-La-Bastide-Puylaurent": "FR-30-48", "Lozere-Bondons": "FR-30-48",
    ...
    "UK-PennineWay-AlstonGarrigill": "UK-IE",
    # Norvège — Lofoten est à ~750 km du centroïde SCAND-NO (Jotunheimen) : code dédié.
    "NO-Lofoten-KvalvikaRyten": "SCAND-NO-Lofoten",
    # Baléares
