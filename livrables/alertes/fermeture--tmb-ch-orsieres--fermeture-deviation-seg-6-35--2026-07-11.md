...
statut: ACTIF — INCHANGÉ 08/09 : CSV officiel data.geo.admin.ch revérifié, entrée toujours
  ...
  val Ferret : cela concerne vraisemblablement un tronçon distinct de celui-ci (voir la
  nouvelle fiche `fermeture|VS-Orsieres-ValFerret|Saleinaz-cabane-eboulement|2026-07-29`),
  le flux officiel ne montrant aucun changement sur ce segment précis depuis le 08/07. À
  reconfirmer au prochain passage CH-VALAIS-VAUD.
ordre: 26
---
...
Nouveau tracé balisé et opérationnel depuis le 11/07 (rive droite de la Dranse de Ferret). Camping et bivouac interdits dans le secteur ; alternatives : camping des Glaciers (La Fouly), Rocailles, Relais d'Arpette.

## Zone (détails)

Flux data.geo.admin.ch `ch.astra.wanderland-sperrungen_umleitungen` (dernière MAJ flux 08/07/2026, champ officiel `reason_fr`="Autre" toujours générique) ; motif et portion précisés via presse (Le Nouvelliste, relayé par FFRandonnée).
