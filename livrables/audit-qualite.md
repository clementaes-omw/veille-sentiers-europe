# Audit qualité du registre — 2026-08-17

71 alertes actives · 4 fiches avec au moins un constat · **0 bloquant(s)**, 4 alerte(s), 0 info(s).
...
- **`risque-feu|Alberes-66|fermeture-massif-GR10|2026-07-10`** — alerte rouge appuyée sur une source datée du 29/07 (19 j) — retrouver une publication récente ou dégrader la sévérité.
- **`risque-feu|FR-06-AlpesMaritimes|fermeture-esterel-tanneron|2026-07-17`** — alerte rouge appuyée sur une source datée du 05/08 (12 j) — retrouver une publication récente ou dégrader la sévérité.
