# Audit qualité du registre — 2026-08-28

73 alertes actives · 7 fiches avec au moins un constat · **0 bloquant(s)**, 7 alerte(s), 0 info(s).
...
- **`fermetures-sentiers|Réunion-974|AP-2026-693|2026-05-21`** — vérifiée il y a 22 j (seuil 12 j — sévérité moyenne). Le site présente cette restriction comme actuelle.
- **`fermeture|Cotes-Armor-Trebeurden|GR34-Pors-Mabo-Goas-Lagorn|2026-08-06`** — jamais revérifiée depuis sa détection il y a 9 j.
...
- **`refuge|GR221-222-Mallorca|refuges-Consell-fermes|2026-08-01`** — vérifiée il y a 21 j (seuil 12 j — sévérité moyenne). Le site présente cette restriction comme actuelle.
